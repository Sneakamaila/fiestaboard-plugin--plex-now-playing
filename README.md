...
## Installation
curl -X POST http://YOUR-IP:4420/api/plugins/install -H "Content-Type: application/json" -d '{"repository": "https://github.com/YOUR-USERNAME/fiestaboard-plugin--plex-now-playing"}'
